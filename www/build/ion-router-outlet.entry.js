import { r as registerInstance, d as createEvent, e as getContext, c as getIonMode, h, f as getElement } from './chunk-8bad6bbf.js';
import { a as attachComponent, d as detachComponent } from './chunk-a88b8db5.js';
import { t as transition } from './chunk-a2caf204.js';
...
class RouterOutlet {
    ...
    async componentDidLoad() {
        this.gesture = (await __sc_import_app('./swipe-back-8bd3053e.js')).createSwipeBackGesture(this.el, () => !!this.swipeHandler && this.swipeHandler.canStart(), () => this.swipeHandler && this.swipeHandler.onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
            if (this.ani) {
