import { r as registerInstance, d as createEvent, e as getContext, B as Build, c as getIonMode, h, f as getElement } from './chunk-8bad6bbf.js';
import { b as assert } from './chunk-3702a6ef.js';
import { a as attachComponent } from './chunk-a88b8db5.js';
import { l as lifecycle, L as LIFECYCLE_WILL_UNLOAD, a as LIFECYCLE_WILL_LEAVE, b as LIFECYCLE_DID_LEAVE, t as transition, s as setPageHidden } from './chunk-a2caf204.js';
...
class Nav {
    ...
    async componentDidLoad() {
        this.rootChanged();
        this.gesture = (await __sc_import_app('./swipe-back-8bd3053e.js')).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
