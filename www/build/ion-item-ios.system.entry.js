System.register(['./chunk-a61457cf.system.js', './chunk-f43705e2.system.js'], function (exports) {
    'use strict';
    var registerInstance, getContext, getIonMode, h, getElement, Host, createColorClasses, hostContext, openURL;
    return {
        ...
        execute: function () {
            ...
            var Item = /** @class */ (function () {
                ...
                Item.prototype.__stencil_render = function () {
                    var _this = this;
                    var mode = getIonMode(this);
                    var _a = this, detail = _a.detail, win = _a.win, detailIcon = _a.detailIcon, routerDirection = _a.routerDirection;
                    var clickable = this.isClickable();
                    var TagType = clickable ? (this.href === undefined ? 'button' : 'a') : 'div';
                    ...
                    return [
                        h(TagType, Object.assign({}, attrs, { class: "item-native", disabled: this.disabled, onClick: function (ev) { return openURL(win, _this.href, ev, routerDirection); } }), h("slot", { name: "start" }), h("div", { class: "item-inner" }, h("div", { class: "input-wrapper" }, h("slot", null)), h("slot", { name: "end" }), showDetail && h("ion-icon", { icon: detailIcon, lazy: false, class: "item-detail-icon" }), h("div", { class: "item-inner-highlight" })), clickable && mode === 'md' && h("ion-ripple-effect", null)),
