import { r as registerInstance, c as getIonMode, e as getContext, h, f as getElement, H as Host } from './chunk-8bad6bbf.js';
...
class BackButton {
    ...
    hostData() {
        ...
        return {
            ...
            class: Object.assign({}, createColorClasses(color), { [`${mode}`]: true, 'button': true, 'back-button-disabled': disabled, 'back-button-has-icon-only': hasIconOnly, 'ion-activatable': true, 'ion-focusable': true, 'show-back-button': showBackButton })
        };
    }
    __stencil_render() {
